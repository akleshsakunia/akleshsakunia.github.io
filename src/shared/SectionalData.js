export default {
  "WORK EXPERIENCE": {
    ...
    content: [
      {
        subHeading: "Software Engineer - Cybage Software Pvt. Ltd.",
        innerContent: [
    ...
    content: [
      {
        ...
        innerContent: [
          ...
          "Created a CI/CD application(mobile first) with Flask +ReactJs and a few shell scripts for deployment of 6 apps and infra needs over 4 different AWS accounts.",
        ],
      },
      {
